...
def num_points_scored(player)
  game_hash.each do |where, team|
    team.each do |details, data|
      ...
      data.each do |array|
        return array[:points] if array[:player_name] == player
      end 
      end
    end
  end
...
def shoe_size(player)
  game_hash.each do |where,team|
    team.each do |details,info|
      if details == :players
        info.each do |array|
          return array[:shoe] if player == array[:player_name]
        end 
      end 
    end 
  end
...
def team_colors(group)
  game_hash.each do |where, team|
    if team[:team_name] == group
      return team[:colors]
    end 
  end 
end 
...
def player_numbers(team)
  numbers = []
  game_hash.each do |where,group|
    group.each do |details,info|
      if details == :players
        info.each do |key,value|
          numbers << key[:number] if team == group[:team_name]
        end
      end 
    end 
  end 
